  ...
  return (
    <Layout>
      ...
      <div className="row">
        ...
        {showfilter?<Filter showfilter={showfilter} setshowfilter={setshowfilter} setselectedBrands={setselectedBrands} setValue={setValue} selectedBrands={selectedBrands} searchTerm={searchTerm} setSearchTerm={setSearchTerm} selectedCategories={selectedCategories} setSelectedCategories={setSelectedCategories} />:<></>}
